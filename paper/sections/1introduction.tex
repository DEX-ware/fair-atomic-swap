...
However, the Atomic Swap is designed for currency exchange rather than options, and \MOD{\sout{the currency exchange should not have Optionality} there is no Optionality in currency exchange}.
