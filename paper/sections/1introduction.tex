...
Estimating the premium is based on the Cox-Ross-Rubinstein option pricing model, which is a conventional model to price the American-style options in Finance.
