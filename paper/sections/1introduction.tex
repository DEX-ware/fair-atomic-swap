...
If the underlying asset price rises, he will proceed the swap so that he will profit.
If the underlying asset price drops, he can abort the swap, so that he won't lose any money.
