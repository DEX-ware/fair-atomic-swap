...
Second, \HY{if having two parties reserving unequal rights, there is no research on the study of the risks they may encounter are equal, given that} the initiator in Atomic Swap can control the settlement time, while the asset price is fluctuating overtime.
