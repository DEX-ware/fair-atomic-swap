...
Both protocols can be implemented on existing blockchains: \TODO{Will it be better not to capitailize? (While it is acceptable to capitalize the first letter after the colon in American English, it is not the case in British English, except where a proper noun immediately follows a colon. https://en.wikipedia.org/wiki/Colon_(punctuation))}
