...
% optionality
A persom entitled ZmnSCPxj initated a discussion at the Lightning-dev mailing list~\cite{optionality-origin} that, this problem is equivalent to the Optionality in Finance, which has already been studied for decades~\cite{higham2004introduction}.
