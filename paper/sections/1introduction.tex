...
Estimating the premium is based on the Cox-Ross-Rubinstein option pricing model, which is a conventional \cancel{model}\TODO{one} to price the American-style options in Finance.
