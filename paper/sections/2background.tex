...
This section briefly explains the basic knowledge of Atomic Swaps and Option and their rules, apart from the tools needed to conduct them.
We further explore the detailed similarities and differences between an Atomic Swap and an Option later in Section ~\ref{sec:formalization}.
...
In Blockchain, the Atomic Swap is realized by the Hashed Timelocked Contract (HTLC)~\cite{poon2016bitcoin}.
