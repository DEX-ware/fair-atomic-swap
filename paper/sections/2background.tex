...
Unlike \textit{Notary schemes} and \textit{Sidechains/relays}, \textit{Hash-locking}, where the Hashed Timelocked Contract (HTLC)~\cite{poon2016bitcoin} is used, empowers the Atomic Swap to be realized without trusted third parties.
