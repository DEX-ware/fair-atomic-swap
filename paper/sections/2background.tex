...
In Blockchain, considering different assets are stored on different corresponding chains, the atomic swap will require the capability of \textit{Chain Interoperability}, for the purpose of value circulation between two varied chains. As stated by Buterin V., 
there are three primary categories of strategies to achieve \textit{Chain Interoperability}~\cite{buterin2016chain}:\\
...
Unlike \textit{Sidechains/relays} and \textit{Notary schemes}, \textit{Hash-locking}, where the Hashed Timelocked Contract (HTLC)~\cite{poon2016bitcoin} is used, empowers the Atomic Swap to be realized without any framework or trusted third party.
