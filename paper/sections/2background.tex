...
In Blockchains, since different assets are stored on different corresponding chains, implementing Atomic Swap requires \textit{Chain Interoperability} - the capability for varied but correlated blockchains to communicate and cooperate with one another.
