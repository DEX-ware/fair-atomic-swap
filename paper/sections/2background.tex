...
In Blockchain, the Atomic Swap is realized by the Hashed Timelocked Contract (HTLC)~\cite{poon2016bitcoin}. The HTLC was originally introduced to secure routing across multiple payment channels~\cite{paymentchan-btcwiki} - which aim at accerelating up trasactions by allowing users to make multiple transactions without commiting all of them.
