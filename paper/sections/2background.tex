...
In Blockchain, considering different assets are stored on different corresponding chains, the Atomic Swap requires the capability of \textit{Chain Interoperability}, for the purpose of value circulation between two varied chains. There are three primary categories of strategies to achieve \textit{Chain Interoperability}~\cite{buterin2016chain}:\\
