...
To implement our protocols, the blockchain should support 1) stateful transactions, 2) the timelock and 3) the hashlock.
...
% because stateless
Unfortunately, Bitcoin cannot support our protocols directly, because Bitcoin does not support the stateful transaction functionalities.
