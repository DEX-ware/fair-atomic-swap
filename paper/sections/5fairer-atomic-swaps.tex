...
The currency exchange and the American Call Options differ.
In finance, the currency exchange is by Spot Contracts, while the American Call Options are by Option Contracts.
A Spot Contract is a contract for buying or selling a commodity, security or currency for immediate settlement.
An Option Contract is a contract that gives the buyer of the option the right to 

from the following aspects:

\begin{itemize}
    \item \textbf{Price of the contract itself}: For the currency exchange, the contract itself is free. For the American Call Options, the contract is priced - the premium.
    \item \textbf{Atomicity}: For the American Call Options, the buyer can abort the contract with the cost of the premium, and the seller cannot.
    For the currency exchange, neither of the parties can abort the exchange after participating in it.
    % TODO
\end{itemize}
