...
\JS{This is not very clear. We should state the exact problem of the unfairness, i.e, Alice can abort the protocol for its profit with no punishment, but Bob cannot. (added by Runchao)}
