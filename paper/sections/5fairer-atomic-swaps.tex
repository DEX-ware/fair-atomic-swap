...
\TODO{merge two protocols to one. describe only one protocol, and add a single paragraph for another one.
remember to keep consistent out of the whole paper (1 improvement on the atomic protocol to make it fair)}
