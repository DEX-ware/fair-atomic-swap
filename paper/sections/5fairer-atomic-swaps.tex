...
Before designing a fair Atomic Swap protocol, we should \MOD{\sout{know} figure} its design objective \MOD{out}:
...
For the currency exchange, both parties \MOD{\sout{should not} are not permitted to} abort the contract once signed.
