...
In this section, we evaluate the unfairness of Atomic Cross-Chain Swaps. \TODO{more intro}
...
the currency exchange rate data was retrieved from Investing.com. \TODO{Give references or footnotes.}
...
\begin{figure}
    ...
    \caption{Diagram showing the unfairness. \TODO{more words}}
...
\begin{figure}
    ...
    \caption{Comparing the unfairness. \TODO{more words}}
...
\TODO{change it to ``where sigma is daily percent change...''}
...
\paragraph{Experimental methodology}
We use the same dataset as Section~\ref{subsec:volatility_analysis}.
We 

\TODO{Analysis based on CRR model}

\begin{figure}
    \includegraphics[width=\linewidth]{premium_pricing_result.eps}
    \caption{Premium pricing result. \TODO{more words}}
