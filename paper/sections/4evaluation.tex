...
In Finance, the Black-Scholes (BS) Model is utilised to price the European Call Options,
while the Cox-Ross-Rubinstein (CRR) Model is utilised to price the American Call Options.
