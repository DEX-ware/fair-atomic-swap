...
The unfairness consists of two parts, namely the profit when Bob's asset price rises and the mitigated loss when Bob's asset price drops.
Figure~\ref{fig:unfair_diagram} visualises the unfairness.
When Bob's asset price rises, Alice profits directly, and this scenario lays on the profit area in Figure~\ref{fig:unfair_diagram}.
When Bob's asset price drops, Alice can abort the swap and transfer the loss to Bob. This scenario lays on the risk area in Figure~\ref{fig:unfair_diagram}.
}
