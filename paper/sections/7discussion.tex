...
Blockchains timestamp \HY{(is ``timestamp'' a verb here? sorry but I cannot find any example usage online)} events by either two approaches: using the block height or using the UNIX timestamp.
% relative time
