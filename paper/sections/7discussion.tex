...
Unfortunately, short timelocks may cause unexpected \MOD{\sout{situations} consequences}.
Confirming transactions for setting up Atomic Swaps takes time, and the \MOD{\sout{needed time} time required} is highly \MOD{\sout{random} unpredictable}.
...
The initiators of Atomic Swaps \MOD{\sout{should have} need having} some participant's asset to initiate an Atomic Swap,
