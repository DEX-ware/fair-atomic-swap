...
Note that the value can be negative\MOD{, which is at most $C$. This implies that the buyer may confront a loss at the most value of $C$. However, the buyer can also choose to abort the contract to mitigate his loss, if he finds the deal is unbeneficial}.
