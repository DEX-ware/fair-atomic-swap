...
To estimate the premium, we use the conventional Cox-Ross-Rubinstein option pricing model, and the results show that the \MOD{estimated} premium for cryptocurrencies is 2\% $\sim$ 3\% of the asset value, while the premium for stocks and fiat currencies is negligible.
