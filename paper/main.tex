...
Second, we evaluate the unfairness of the Atomic Swap and compare it with that of conventional financial assets (stocks and fiat currencies).
...
To estimate the premium, we use the conventional Cox-Ross-Rubinstein option pricing model, and the results show that the estimated premium for cryptocurrencies is 2\% $\sim$ 3\% of the asset value, while the premium for stocks and fiat currencies is negligible.
