...
% 1
First, we model the Atomic Swap as the American Call Option, and prove an Atomic Swap is equivalent to an American Call Option without the premium, thus is unfair to the swap participant.
Second, we quantify the unfairness of Atomic Swap and compare it with that of conventional financial assets (stocks and fiat currencies).
...
% 3
Last, we propose two fair Atomic Swap protocols, one is for currency exchange and the other is for American Call Options.
...
In addition, we give the reference implementation of our protocols in Solidity, and give detailed instructions on implementing our protocols with Bitcoin script.
\end{abstract}
